...
export const TrashIcon: Component<{class?: string}> = (props) => {
  const merged = mergeProps({class: "w-5 h-5 stroke-black"}, props);

  // https://www.svgrepo.com/show/380116/trash-delete-bin.svg
  return (
    <svg xmlns="http://www.w3.org/2000/svg" class={merged.class} viewBox="0 0 24 24" fill="none">
      <path d="M3 6H21M5 6V20C5 21.1046 5.89543 22 7 22H17C18.1046 22 19 21.1046 19 20V6M8 6V4C8 2.89543 8.89543 2 10 2H14C15.1046 2 16 2.89543 16 4V6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
export const EyeIcon: Component<{class?: string}> = (props) => {
  const merged = mergeProps({class: "w-5 h-5 fill-black"}, props);

  // https://www.svgrepo.com/show/521651/eye-off.svg
  return (
    <svg xmlns="http://www.w3.org/2000/svg" class={merged.class} viewBox="0 0 24 24" fill="none">
